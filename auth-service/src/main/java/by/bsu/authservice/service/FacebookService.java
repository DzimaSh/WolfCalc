...
import by.bsu.authservice.client.FacebookClient;
import by.bsu.authservice.exception.InternalServerException;
import by.bsu.authservice.model.InstaUserDetails;
import by.bsu.authservice.model.Role;
import by.bsu.authservice.model.facebook.FacebookUser;
...
public class FacebookService {
    ...
    public String loginUser(String fbAccessToken) {
        ...
        return userService.findById(facebookUser.getId())
                .or(() -> Optional.ofNullable(authService.registerUser(convertTo(facebookUser), Role.FACEBOOK_USER)))
